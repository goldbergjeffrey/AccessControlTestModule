...
1. Installation:
	...
	* Access the platform on <strong>https://[Qlik Sense proxy server]/custom/hub</strong> or <strong>https://[Qlik Sense proxy server]/custom/qmc</strong> and you will be redirected to the authentication module where login will become possible.
